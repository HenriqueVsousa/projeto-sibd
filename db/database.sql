...
CREATE TABLE map (id INTEGER PRIMARY KEY ASC AUTOINCREMENT, name VARCHAR NOT NULL, usr VARCHAR REFERENCES user (id) ON DELETE CASCADE ON UPDATE NO ACTION NOT NULL);
